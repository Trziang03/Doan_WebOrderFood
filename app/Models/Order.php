...
class Order extends Model
{
    ...
    protected $fillable = ['id', 'order_code', 'table_id', 'full_name', 'phone', 'address', 'total_price', 'payment_method_id', 'user_id', 'voucher_id', 'order_status_id'];    //tạo mã hóa đơn order_code năm (2 chữ số), tháng, ngày, giờ phút giây và 2 số ngẫu nhiên
