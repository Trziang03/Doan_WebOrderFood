...
@section('content')
    ...
    <section id="gioithieu" class="intro" style="background-color:#fff2e6;">
        <h2>Về Chúng Tôi</h2>
        <p>Gidu Food là cửa hàng chuyên cung cấp các món ăn nhanh hấp dẫn, phục vụ nhanh chóng, tiện lợi với giá cả hợp lý.
            Đội ngũ đầu bếp chuyên nghiệp và nguyên liệu sạch giúp bạn luôn an tâm khi thưởng thức.</p>
        <p>GiDu Food – Thế giới ăn vặt đậm chất Việt!
            Chuyên bán bánh tráng, trà sữa các loại, giá bình dân, phục vụ nhanh – chuẩn vị học trò, sinh viên và dân văn
            phòng. </p>
    </section>
